...
## Future Goals:
- Voice activate the AI assistant from anywhere on the app by saying "Hey NOCH"
- Add many more behaviors to the AI. Making reservations, leaving reviews, ordering ahead, navigating to restraunts, etc...
- Add text to speech so the AI can audibly reply to prompts.
